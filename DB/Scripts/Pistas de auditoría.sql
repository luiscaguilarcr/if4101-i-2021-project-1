...
ALTER TABLE [dbo].[Course] 
ADD CONSTRAINT DF_Creation_User_Course DEFAULT GETDATE() FOR Creation_User
ALTER TABLE [dbo].[Course] 
ADD CONSTRAINT DF_Update_Date_Course DEFAULT 'DBA' FOR Update_Date
ALTER TABLE [dbo].[Course] 
...
ALTER TABLE [dbo].[Student] 
ADD CONSTRAINT DF_Creation_User_Student DEFAULT GETDATE() FOR Creation_User
ALTER TABLE [dbo].[Student] 
ADD CONSTRAINT DF_Update_Date_Student DEFAULT 'DBA' FOR Update_Date
ALTER TABLE [dbo].[Student] 
...
ALTER TABLE [dbo].[Group] 
ADD CONSTRAINT DF_Creation_User_Group DEFAULT GETDATE() FOR Creation_User
ALTER TABLE [dbo].[Group] 
ADD CONSTRAINT DF_Update_Date_Group DEFAULT 'DBA' FOR Update_Date
ALTER TABLE [dbo].[Group] 
...
ALTER TABLE [dbo].[Professor] 
ADD CONSTRAINT DF_Creation_User_Professor DEFAULT GETDATE() FOR Creation_User
ALTER TABLE [dbo].[Professor] 
ADD CONSTRAINT DF_Update_Date_Professor DEFAULT 'DBA' FOR Update_Date
ALTER TABLE [dbo].[Professor] 
...
ALTER TABLE [dbo].[Professor_Course_Group] 
ADD CONSTRAINT DF_Creation_User_Professor_Course_Group DEFAULT GETDATE() FOR Creation_User
ALTER TABLE [dbo].[Professor_Course_Group] 
ADD CONSTRAINT DF_Update_Date_Professor_Course_Group DEFAULT 'DBA' FOR Update_Date
ALTER TABLE [dbo].[Professor_Course_Group] 
...
ALTER TABLE [dbo].[Student_Course_Group] 
ADD CONSTRAINT DF_Creation_User_Student_Course_Group DEFAULT GETDATE() FOR Creation_User
ALTER TABLE [dbo].[Student_Course_Group] 
ADD CONSTRAINT DF_Update_Date_Student_Course_Group DEFAULT 'DBA' FOR Update_Date
ALTER TABLE [dbo].[Student_Course_Group] 
