...
namespace Project_SPA.Controllers
{
    public class UserController : Controller
    {
        ...
        public Boolean ValidateAdmin(Professor professor, User user)
        {
            if (professor.Code.Equals(user.Code) && professor.Password.Equals(user.Paswword))
            {
                return true;
            }
            return false;
        ...
        {
            if (student.Code.Equals(user.Code) && student.Password.Equals(user.Paswword))
            {
                return true;
            }
            return false;
